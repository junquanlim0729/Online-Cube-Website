...
<style>
  html, body { scrollbar-gutter: stable both-edges; overflow-y: auto; overflow-x: hidden; }
  html, body { margin: 0 !important; padding: 0 !important; border: none !important; outline: none !important; box-shadow: none !important; }
</style>
<header id="custHeader" style="background:#000; color:#fff; border-bottom:1px solid #333; margin:0 !important; padding:10px 0; text-align:left; position:fixed; top:0; left:0; right:0; width:100%; height:60px; z-index: 1000; transition: transform 0.25s ease; box-sizing:border-box;">
    <div style="max-width:1200px; margin:0 auto; padding:0 20px; display:flex; align-items:center; justify-content:space-between; height:100%; box-sizing:border-box;">
