<ul style="list-style-type: none; padding: 0; margin: 0;">
    ...
    <li><a href="?page=admin_manage_category.php" style="display: block; padding: 10px; text-decoration: none; color: #333; transition: background-color 0.3s;">Manage Categories</a></li>
    <li><a href="?page=admin_manage_product.php" style="display: block; padding: 10px; text-decoration: none; color: #333; transition: background-color 0.3s;">Manage Products</a></li>
    <li><a href="?page=admin_manage_color.php" style="display: block; padding: 10px; text-decoration: none; color: #333; transition: background-color 0.3s;">Manage Colors</a></li>
    ...
    <li><a href="admin_logout.php" style="display: block; padding: 10px; text-decoration: none; color: #333; transition: background-color 0.3s;">Logout</a></li>
</ul>
<style>
    ul li a:hover {
