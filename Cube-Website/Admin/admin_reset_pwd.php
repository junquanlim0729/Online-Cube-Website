    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_reset'])) {
        ...
        if (empty($new_password) || empty($confirm_password)) {
            ...
            if ($length < 8 || $length > 20) {
                ...
                // Check old password
                $check_sql = "SELECT Staff_Password FROM Staff WHERE Staff_Email = ?";
...
<body>
    <div class="container">
        ...
        <p><a href="admin_login.php">Go Home</a></p>
    </div>

    <script>
        // Intercept back button and redirect to admin_login.php only if coming from reset or forgot flow
